...
export const LocalText = {
  ...
  notification_quote_of_the_day_desc: 'Send a quote at #:00 AM every day',
  notification_fact_of_the_day: "Fact of the day",
  notification_fact_of_the_day_desc: 'Send a fun fact at #:00 every day.',
  notification_joke_of_the_day: "Joke of the day",
  notification_joke_of_the_day_desc: 'Send a joke at #:00 every day.',
  community: "Community",
  feedback: "Feedback",
  error: "Error",
